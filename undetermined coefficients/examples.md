...
RHS contains \(\sin 4x\), which appears in the complementary function.

So multiply the trial solution by \(x\).
...
- If the trial solution duplicates the CF → multiply by \(x\).
